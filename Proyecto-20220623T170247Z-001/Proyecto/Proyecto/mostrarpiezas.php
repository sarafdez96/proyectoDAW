...
<!--creamos dos enlaces (uno para que el usuario acceda a la pagina y otro para que se dirija a su cuenta-->
<!--<br>
<form method="POST" action="busquedap.php" id="busqueda">
<input type="text" id="palabras" name="palabras" size="30" maxlength="30" placeholder="Buscar por marca">
